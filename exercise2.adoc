...
This step requires that the custom JBoss EAP container was built as part of exercise 1 and it also requires that you copy jboss-dev.env.
+
[source]
----
$ cp ~/docker-jboss-eap/lab/jboss-dev.env .
