...
## 3.3 Create a pod for JBoss EAP
...
[source,yaml]
----
.Now, restart the JBoss EAP pod, so that it picks up the changes we've made to the docker container. You should see Postgres being used **TODO - how**.
